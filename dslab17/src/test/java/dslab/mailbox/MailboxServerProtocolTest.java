...
public class MailboxServerProtocolTest extends TestBase {
    ...
    @Test(timeout = 15000)
    public void acceptDmepMessage_listDmapMessage() throws Exception {

        // accept a message via DMEP (to trillian)
        try (JunitSocketClient client = new JunitSocketClient(dmepServerPort, err)) {
            client.verify("ok DMEP");
    ...
    @Test(timeout = 15000)
    public void dmepMessage_withUnknownRecipient_returnsError() throws Exception {
